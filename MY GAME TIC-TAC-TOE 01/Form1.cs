    ...
    public partial class Form1 : Form
    {
        ...
        private void buttontic3_Click(object sender, EventArgs e)
        {
            if (buttontic3.Text == "")
            {
                ...
                if (buttontic3.Text == buttontic5.Text)
                {
                    if (buttontic5.Text == buttontic7.Text)
                    {
                        MessageBox.Show("You are the Winner!" + buttontic3.Text);
                        buttontic1.Text = "";
                        buttontic2.Text = "";
        ...
        private void buttontic4_Click(object sender, EventArgs e)
        {
            if (buttontic4.Text == "")
            {
                ...
                if (buttontic4.Text == buttontic7.Text)
                {
                    if (buttontic7.Text == buttontic1.Text)
                    {
                        MessageBox.Show("You are the Winner!" + buttontic4.Text);
                        buttontic1.Text = "";
                        buttontic2.Text = "";
        ...
        private void buttontic5_Click(object sender, EventArgs e)
        {
            if (buttontic5.Text == "")
            {
                ...
                if (buttontic5.Text == buttontic6.Text)
                {
                    if (buttontic6.Text == buttontic4.Text)
                    {
                ...
                if (buttontic5.Text == buttontic2.Text)
                {
                    if (buttontic2.Text == buttontic8.Text)
                    {
                        MessageBox.Show("You are the Winner!" + buttontic5.Text);
                        buttontic1.Text = "";
                        buttontic2.Text = "";
        ...
        private void buttontic7_Click(object sender, EventArgs e)
        {
            if (buttontic7.Text == "")
            {
                ...
                if (buttontic7.Text == buttontic4.Text)
                {
                    if (buttontic4.Text == buttontic1.Text)
                    {
                        MessageBox.Show("You are the Winner!" + buttontic7.Text);
                        buttontic1.Text = "";
                        buttontic2.Text = "";
                ...
                if (buttontic7.Text == buttontic5.Text)
                {
                    if (buttontic5.Text == buttontic3.Text)
                    {
                        MessageBox.Show("You are the Winner!" + buttontic7.Text);
                        buttontic1.Text = "";
                        buttontic2.Text = "";
        ...
        private void buttontic8_Click(object sender, EventArgs e)
        {
            if (buttontic8.Text == "")
            {
                ...
                if (buttontic8.Text == buttontic5.Text)
                {
                    if (buttontic5.Text == buttontic2.Text)
                    {
                        MessageBox.Show("You are the Winner!" + buttontic8.Text);
        ...
        private void buttontic9_Click(object sender, EventArgs e)
        {
            if (buttontic9.Text == "")
            {
                buttontic9.Text = Valuebtntic;
                if (Valuebtntic == "X")
                {
                    Valuebtntic = "O";
                }
                ...
                if (buttontic9.Text == buttontic8.Text)
                {
                    if (buttontic8.Text == buttontic7.Text)
                    {
                        MessageBox.Show("You are the Winner!" + buttontic9.Text);
                        buttontic1.Text = "";
                        buttontic2.Text = "";
                        buttontic3.Text = "";
                        buttontic4.Text = "";
                ...
                if (buttontic9.Text == buttontic5.Text)
                {
                    if (buttontic5.Text == buttontic1.Text)
                    {
                        MessageBox.Show("You are the Winner!" + buttontic9.Text);
                        buttontic1.Text = "";
                        buttontic2.Text = "";
                ...
                if (buttontic9.Text == buttontic6.Text)
                {
                    if (buttontic6.Text == buttontic3.Text)
                    {
                        MessageBox.Show("You are the Winner!" + buttontic9.Text);
